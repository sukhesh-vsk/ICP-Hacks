                ...
                <a href="/results/viewprojects#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    ...
                    <div class="flex flex-col justify-between p-4 pe-0 leading-normal">
                        ...
                        <button href="#" className={`flex w-24 items-center px-3 py-1 text-sm font-medium text-center text-prime-text ring-1 ring-prime-text rounded-lg focus:outline-none dark:bg-prime`} onClick={() => toggleLike(index)}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="Thumbsup" className='w-5 h-5 ms-1'>
                                <path d="M5.5 10.5h-5a.5.5 0 0 0-.5.5v12a.5.5 0 0 0 .5.5h5A.5.5 0 0 0 6 23V11a.5.5 0 0 0-.5-.5zM24 11c0-1.378-1.122-2.5-2.5-2.5h-6.295c.305-.929.795-2.632.795-4 0-2.169-1.843-4-3-4-1.039 0-1.781.584-1.813.609A.504.504 0 0 0 11 1.5v3.39l-2.88 6.241-.843.421A.503.503 0 0 0 7 12v9c0 .133.053.26.146.354.749.748 2.429 1.146 3.354 1.146h9.25a2.252 2.252 0 0 0 2.015-3.25 2.24 2.24 0 0 0 1-3 2.24 2.24 0 0 0 1.235-2c0-.6-.239-1.161-.65-1.575.415-.452.65-1.044.65-1.675z" 
                                    fill={(liked[index]) ? '#025514' : 'none'} stroke={(liked[index]) ? 'none' : '#025514'}  strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
